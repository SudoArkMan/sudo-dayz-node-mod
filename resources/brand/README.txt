...
logo/
  sudo-corner-320x50.png     toolbar slot, 1x
  sudo-corner-320x50@2x.png  toolbar slot, 2x
  sudo-lockup-dark.png       horizontal lockup on dark, 2x (1760x372)
  sudo-lockup-light.png      horizontal lockup on light, 2x (1760x372)

splash/
  sudo-splash-760x440.png    1x
  sudo-splash-760x440@2x.png 2x
...
Type
  Segoe UI Light (weight 200-300), tracking 0.04em on SUDO,
  0.12-0.32em on SERVERS / VISUAL SCRIPTING TOOLS.
